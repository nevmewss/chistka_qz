...
$source = trim((string) ($_POST['source'] ?? 'dental-hygiene-lviv-quiz'));
...
$displayName = $name !== '' ? $name : 'Не вказано';

$messageParts = [
    'Нова заявка з квізу професійної гігієни',
    '',
    'Імʼя: ' . $displayName,
    'Телефон: ' . $phone,
...
$subjectText = 'Нова заявка з квізу професійної гігієни';
